...
?>
  ...
  ?></h1></a>
    <ul>
      ...
      <li id="Mgallery" class="icon"><a class="eventButton-gallery" title="Event Gallery" href="<?php echo home_url(); ?>/<?php echo $slug;?>/<?php echo $slug;?>-gallery"><span class="alt">Event Gallery</span></a></li>
