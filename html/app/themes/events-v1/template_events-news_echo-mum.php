...
Template Name: Events News (Mum of the Year)
...
<?php get_header(); ?>
        ...
        <?php while ( have_posts() ) : the_post(); ?>
            ...
            <article id="post-<?php the_ID(); ?>" class="eventPage">
                ...
                <div id="post" class="prefix_1 grid_16 suffix_1 clearfix news">
                    ...
                    <div class="grid_8 suffix_1 grid_omega"><?php the_content(''); ?></div>
