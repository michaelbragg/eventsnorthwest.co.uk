...
<!--        <header class="prefix_1 grid_14 suffix_1"><h1></h1>
      ...
      <li id="Mcontact" class="icon"><a class="sprite icon__sidebar icon__sidebar--contact" title="Contact Events" href="<?php echo home_url(); ?>/<?php echo $slug;?>/<?php echo $slug;?>-contact"><span class="alt">Contact Events</span></a></li>
	    ...
	    <header id="eHeader" class="prefix_1 grid_16 suffix_1"><a href="<?php echo home_url(); ?>/<?php echo $slug;?>/<?php echo $slug;?>" title="<?php echo the_title(); ?>">
        ...
        <ul>
            ...
            <li id="Mcategories"><a title="Entry Form" href="<?php echo home_url(); ?>/<?php echo $slug;?>/<?php echo $slug;?>-entry-form">Entry Form</a></li>
