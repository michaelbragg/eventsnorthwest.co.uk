...
<li id="Mgallery" class="icon"><a class="sprite icon__sidebar  icon__sidebar--gallery" title="Event Gallery" href="<?php echo home_url(); ?>/<?php echo $slug;?>/<?php echo $slug;?>-gallery"><span class="alt">Event Gallery</span></a></li>
      ...
      <li id="Mcontact" class="icon"><a class="sprite icon__sidebar icon__sidebar--contact" title="Contact Events" href="<?php echo home_url(); ?>/<?php echo $slug;?>/<?php echo $slug;?>-contact"><span class="alt">Contact Events</span></a></li>
	    ...
	    <header id="eHeader" class="prefix_1 grid_16 suffix_1"><a href="<?php echo home_url(); ?>/<?php echo $slug;?>/" title="<?php echo the_title(); ?>">
        ...
        <ul>
            ...
            <li id="Mcategories"><a title="Entry Form" href="<?php echo home_url(); ?>/<?php echo $slug;?>/<?php echo $slug; ?>-tickets">Buy Tickets</a></li>

            <li id="Msponsors"><a title="Categories &amp; Sponsors" href="<?php echo home_url(); ?>/<?php echo $slug;?>/<?php echo $slug; ?>-our-partners"> Sponsors  &amp; Performers</a></li>
...
if ($publish_page->post_status == 'publish' ) { ?> <li id="Mgallery" class="icon"><a class="sprite icon__sidebar  icon__sidebar--gallery" title="Event Gallery" href="<?php echo home_url(); ?>/<?php echo $slug;?>/<?php echo $slug;?>-gallery"><span class="alt">Event Gallery</span></a></li><?php
    } else {
